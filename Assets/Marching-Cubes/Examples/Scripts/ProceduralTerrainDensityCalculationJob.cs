...
namespace MarchingCubes.Examples
{
    ...
    struct ProceduralTerrainDensityCalculationJob : IDensityCalculationJob
    {
        ...
        public void Execute(int index)
        {
            ...
            float density = (float)new LibNoise.Unity.Generator.Perlin(0.31f, 0.6f, 2.15f, 10, 0, LibNoise.Unity.QualityMode.Low).GetValue(worldPositionX, worldPositionY, worldPositionZ) / 200; ;
