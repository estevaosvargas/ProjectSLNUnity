...
public class ItemDataBaseFile
{
    public static Dictionary<int, ItemData> LoadItemDataBase()
    {
        ...
        itemlist.Add(1, SetUpItem(1, "Sword", "SwordSwordSwordSwordSwordSwordSword", Game.SpriteManager.Getitemicon("PickAxe"), ItemRarity.Common, 1, false, true, ItemType.Weapon, MaterialHitType.Rock, new ItemAbout(25, 45, 45, 100, 2, 0.2f)));
