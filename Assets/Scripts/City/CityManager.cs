...
public class CityManager : MonoBehaviour
{
    ...
    {
        GameObject obj = DarckNet.Network.Instantiate(Game.SpriteManager.GetPrefabOnRecources("Prefabs/AI/Villager"), spawnPosition, Quaternion.identity, Game.MapManager.World_ID);
