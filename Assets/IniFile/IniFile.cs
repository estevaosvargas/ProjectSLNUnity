...
public class IniFile
{
    ...
    public IniFile(string file, string patch)
    {
        Init();
        Load(file, patch);
    }
...
#else
	public void Save(string fileName, string patch)
    {
	string filePath = patch + fileName + ".ini";
...
#else
    public void Load(string fileName, string patch)
    {
        string filePath = patch + fileName + ".ini";
